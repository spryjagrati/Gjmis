...
<div id="importCsvSteps">
    ...
    <div id="importCsvFirstStep">
        ...
        <?php  echo CHtml::button(Yii::t('importcsvModule.importcsv', 'Select CSV File'), array("id"=>"importStep1")); ?><span>*name the file sku.csv for custom upload </span>
    </div>
    ...
    <div id="importCsvThirdStep">
        <?php echo CHtml::beginForm('','post'); ?>
            ...
            <div id="importCsvThirdStepPolesAndForm">
                <div id="importCsvThirdStepPoles" style="overflow:auto; width:895px;">&nbsp;</div><br/>
                <?php
    ...
    <br/>
    <span id="importCsvBread1">&laquo; <?php echo CHtml::link(Yii::t('importcsvModule.importcsv', 'Start over'), "/importcsv");?></span>
