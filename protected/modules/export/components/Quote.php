 ...
 * @author maverick
 */
class Quote extends CController {
    ...
    public function export($id) {
        ...
        $skus = Quote::getSkudata($memoskus);
        ...
        $filepath = Yii::app()->getBasePath() . '/components/exports/quote.xls';
    ...
    public function getSkudata($memoskus){
        ...
        foreach ($memoskus as $memosku){
            ...
            $skus[$memosku->idsku]['metalwt'] = $memosku->getMetalwt($memosku->idsku0->totmetalwei) * $memosku->qty;
