...
class Newstone extends CController {

    public function unqiuestones($stones) {
        $allstones = array();
        $newstones = array();
        $returnarray = array();
        foreach ($stones as $stone) {
            
            if(isset($stone[0]['flag']) && $stone[0]['flag']){
                $stone_string = $stone['name'].'_'.$stone['shape'];
            }else{
                $stone_string = $stone['name'];
            }
            ...
            if (in_array($stone_string, $allstones)) {
                ...
                $newstones[$stone_string]['month'] = $stone['month'];
        ...
        foreach ($newstones as $newstone) {
            ...
            $returnarray[$i]['month'] = $newstone['month'];
            $i++;
        }
    ...
    public function qjcunqiuestones($stones) {
        $allstones = array();
        $newstones = array();
        $returnarray = array();
        foreach ($stones as $stone) {
            
            $stone_string = $stone['name'].'_'.$stone['shape'].'_'.$stone['size'];
