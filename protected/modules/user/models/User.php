...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((Yii::app()->getModule('user')->isAdmin())?array(
		      array('username, password, email iddept', 'required'),
	...
	public function relations()
	{
		$relations = array(
			...
			'iddept0' => array(self::BELONGS_TO, 'Dept', 'iddept'),
                    ...
                    'invoices'=> array(self::HAS_MANY, 'Invoice', ['idlocation'=>'idlocation'])
		);
	...
	public function attributeLabels()
	{
		return array(
			...
			'status' => UserModule::t("Status"),
                        'accessdetails' => UserModule::t("Access Details"),
                    	'idlocation'=>'Location',
			'iddept'=>'Department',
		);
	}
    ...
    {
        return array(
            'select' => 'id, username, iddept,idlocation, email, createtime, lastvisit, superuser, status, accessdetails',
        );
    }
