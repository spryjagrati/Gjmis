...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'findreq-form','action'=>$this->createUrl('purchaseOrder/createRequest/'.$model->idpo),
	...
	<div class="buttonHolder">
		<?php echo CHtml::ajaxSubmitButton($model->isNewRecord?'Create':'Save',array('purchaseOrder/createRequest/'.$model->idpo),array('update'=>'#yw0_tab_3','complete' => 'function(){$.fn.yiiGridView.update("matreq-grid");}',),array('id'=>'matreqfind-create','class'=>'primaryAction', 'style'=>'width:20%')); ?>
	</div>
    </fieldset>
<?php $this->endWidget(); ?>
