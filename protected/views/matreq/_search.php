...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->textField($model,'idmatreq',array('class'=>'textInput','size'=>8,'maxlength'=>8,'style'=>'width:10%')); ?>
		<?php echo $form->label($model,'idpo',array('style'=>'width:10%')); ?>
		<?php echo $form->textField($model,'idpo',array('class'=>'textInput','size'=>8,'maxlength'=>8,'style'=>'width:10%')); ?>
		<?php echo $form->label($model,'type',array('style'=>'width:10%')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->label($model,'idstone',array('style'=>'width:10%')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->label($model,'idfinding',array('style'=>'width:10%')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->label($model,'edate',array('style'=>'width:10%')); ?>
		...
		<?php echo $form->label($model,'estdate',array('style'=>'width:10%')); ?>
	...
	<div class="ctrlHolder">
		<?php echo $form->label($model,'reqby'); ?>
		...
		<?php echo $form->label($model,'reqto',array('style'=>'width:10%')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->textField($model,'cdate',array('class'=>'textInput','style'=>'width:12%;')); ?>
            ...
            <?php $this->widget('application.extensions.calendar.SCalendar',
                array(
                    'inputField'=>'Matreq_cdate',
                    'button'=>'cdate_button',
                    'ifFormat'=>'%Y-%m-%d',
                ));
            ?>
		<?php echo $form->label($model,'mdate',array('style'=>'width:10%')); ?>
		<?php echo $form->textField($model,'mdate',array('class'=>'textInput','style'=>'width:12%;')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'updby', ComSpry::getAllUserDropDownList(),array('class'=>'selectInput','empty' => '','style'=>'width:20%')); ?>
        </div>
