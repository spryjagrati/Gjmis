...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->textField($model,'idpo',array('class'=>'textInput','size'=>8,'maxlength'=>8,'style'=>'width:10%','disabled'=>'disabled')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->textField($model,'sdate',array('class'=>'textInput','style'=>'width:12%;','disabled'=>'disabled')); ?>
		...
		<?php echo $form->textField($model,'edate',array('class'=>'textInput','style'=>'width:12%;','disabled'=>'disabled')); ?>
		...
		<?php echo $form->textField($model,'estdate',array('class'=>'textInput','style'=>'width:12%;','disabled'=>'disabled')); ?>
	...
	<div class="buttonHolder">
		<?php echo CHtml::submitButton('Fulfill',array('class'=>'primaryAction', 'style'=>'width:20%')); ?>
	</div>
    </fieldset>
<?php $this->endWidget(); ?>
