...
<fieldset class="inlineLabels">
	...
	<div class="ctrlHolder">
                <?php echo $form->hiddenfield($model,'idstonestocks'); ?>
		<?php echo $form->labelEx($model,'iddept'); ?>
		<?php echo $form->dropDownList($model,'iddept',ComSpry::getDepts(),array('class'=>'selectInput','empty' => '','style'=>'width:20%','disabled'=>'disabled')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->textField($model,'qty', array('style'=>'width:20%','disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'qty'); ?>
	</div>
        
        <div class="ctrlHolder">
		<?php echo $form->labelEx($model,'stonewt'); ?>
		<?php echo $form->textField($model,'stonewt', array('style'=>'width:20%','disabled'=>'disabled')); ?>
...
<!--	<div class="ctrlHolder">
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'refrcvd',ComSpry::getDepts(),array('class'=>'selectInput','empty' => '','style'=>'width:20%','disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'refrcvd'); ?>
	</div>

	<div class="ctrlHolder">
		<?php echo $form->labelEx($model,'refsent'); ?>
		<?php echo $form->dropDownList($model,'refsent',ComSpry::getDepts(),array('class'=>'selectInput','empty' => '','style'=>'width:20%', 'disabled'=>'disabled')); ?>
