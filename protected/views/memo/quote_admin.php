	...
	'columns'=>array(
		...
		'remark',
			...
			'class'=>'CButtonColumn',
                        ...
                        'buttons'=>array(
                            'update'=>array(
                                'url'=>'Yii::app()->createUrl("memo/updatequote",array("id"=>$data->idmemo))',
                            ),
                            'export'=>array(
                                'imageUrl'=>Yii::app()->request->baseUrl.'/images/export.png',
                                'url'=>'Yii::app()->createUrl("export/skuexport/exportQuote",array("id"=>$data->idmemo))',
                                'options'=>array('style'=>'display:inline-block;margin:5px;'),
                            ),
                            'return'=>array(
                                'imageUrl'=>Yii::app()->request->baseUrl.'/images/return.png',
                                'url'=>'Yii::app()->createUrl("memo/returnQuote",array("id"=>$data->idmemo))',
                                'options'=>array('style'=>'display:inline-block;margin:5px;'),
                            ),
                        ),
