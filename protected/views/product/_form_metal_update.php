...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note">Fields with <span class="required">*</span> are required.</p>
        <span class="required"><?php echo Yii::app()->user->getFlash('updateMetal',''); ?></span>
...
-->
	...
	<div class="buttonHolder">
            <?php
		echo CHtml::ajaxSubmitButton('Save','',array('update'=>'#updateMetalDialog',),array('id'=>'metal-update-'.$model->idskumetals,'class'=>'primaryAction', 'style'=>'width:20%'));
            ?>
	</div>
    </fieldset>
<?php $this->endWidget(); ?>
