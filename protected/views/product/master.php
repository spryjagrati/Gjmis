...
<?php if(!Yii::app()->request->isAjaxRequest)
{
    ?>
<script >
 window.load=function(){alert("<?php Sku::model()->removeCookie('save-selection'); ?>");}
</script>
        <?php
}?>
<?php
...
$('.export').click(function(){
    ...
    if (!checked)
        ...
        alert('Please select atleast one SKU to export');
            ...
            document.getElementById('checked-export').action='export_quotesheet';
		...
		'numstones',
			...
			'value'=>'CHtml::link(
                ...
                array(
                        ...
                        'name' => 'ids[]', ),
                        'checked'=>'$data->getChecked($data->idsku);',                    
