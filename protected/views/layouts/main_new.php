			...
			'items'=>array(
				...
				//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
                            array('label'=>'SKU', 'url'=>array('/product/admin'), 'visible'=>!Yii::app()->user->isGuest,'items'=>array(
                                ...
                                array('label'=>'Aliases', 'url'=>array('/aliases/admin'), 'visible'=>!Yii::app()->user->isGuest),
                                array('label'=>'Categories', 'url'=>array('/category/admin'), 'visible'=>!Yii::app()->user->isGuest),
                                 //array('label'=>'Upload', 'url'=>array('/skucontent/upload'), 'visible'=>!Yii::app()->user->isGuest),
                            )),

                            array('label'=>'Beads', 'url'=>array('/bead/admin') , 'visible'=>!yii::app()->user->isGuest
                            ),
                            ...
                            array('label'=>'Master', 'url'=>array('/product/master'), 'visible'=>!Yii::app()->user->isGuest ,'items'=>array(
                                    array('label' => 'Exports', 'url'=>Yii::app()->getModule('export')->masterUrl, 'visible'=>!Yii::app()->user->isGuest),
                                )),
