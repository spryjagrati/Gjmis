...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/form.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/uni-form.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/blue.uni-form.css" />
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
                            ...
                            array('label'=>'Invoices', 'url'=>array('/invoice/admin'), 'visible'=>Yii::app()->getModule('user')->isAdmin(), 'items' => array(
                            ...
                            array('label'=>'Master', 'url'=>array('/product/master'), 'visible'=>!Yii::app()->user->isGuest ),
