...
<?php $form=$this->beginWidget('ext.wvactiveform.wvActiveForm', array(
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'type',$model->getCaddTypes(),array('disabled'=>'disabled')); ?>
...
<!--
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'idstone',ComSpry::getStones(),array('empty' => '','disabled'=>'disabled')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'idchemical',ComSpry::getChemicals(),array('empty' => '','disabled'=>'disabled')); ?>
	...
	<div class="ctrlHolder">
		...
		<?php echo $form->dropDownList($model,'idsetting',ComSpry::getSettings(),array('empty' => '','disabled'=>'disabled')); ?>
