...
class LocationsController extends Controller
{
	...
	protected function performAjaxValidation($model)
	{
        ...
        /**
         * This function is to create stone stocks in a location
         */
        public function actionAdminStoneStock(){
            

                $count=Yii::app()->db->createCommand('SELECT COUNT(*) FROM tbl_stone')->queryScalar();
                $sql='SELECT st.idstone as idstone, st.namevar as namevar, sz.size as size, st.color as color, st.quality as quality, st.cut as cut, st.weight as weight, st.curcost as curcost FROM tbl_stone st, tbl_stonesize sz where st.idstonesize = sz.idstonesize';
...
//                    ),
               ...
               // echo('<pre>');print_r($dataProvider->getData());die();
