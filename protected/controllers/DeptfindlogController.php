...
class DeptfindlogController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Deptfindlog'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idtbl_deptfindlog));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Deptfindlog');
	...
	public function actionAdmin()
	{
		...
		$model=new Deptfindlog('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Deptfindlog']))
			$model->attributes=$_GET['Deptfindlog'];
	...
	{
		$model=Deptfindlog::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='deptfindlog-form')
		{
        ...
        public function actionStocksUpdate($id)
	{
        ...
        public function actionAjaxUpdategrid(){
             ...
             $model = Deptfindlog::model()->findByPk($value);
             $model->acknow = 1;
             $model->save();
             }
